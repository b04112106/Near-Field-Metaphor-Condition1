...
//     public GameObject oppsiteObject;
...
//     private float maxX = 0.0f, maxY = 0.0f, maxZ = 0.0f;
//     private int flag = 0;
...
//         // string [] x = BoundingBox.transform.GetChild(8).name.Split(' ');
//         SelectedObject = GameObject.Find("statue1");
...
//         for(int i=0; i<6; i++)
//             Faces[i] = GameObject.Find("Face " + i.ToString());
//         CopyOfObject = BoundingBox.transform.GetChild(6).gameObject;
...
//         // GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight.GetComponent<MeshRenderer>().enabled = true;
//     }
//     public void UnTouch()
//     {
//         // GetComponent<MeshRenderer>().enabled = false;
//         // GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight.GetComponent<MeshRenderer>().enabled = false;
//     }
//     public void PressGrip()
//     {
//         // Debug.Log(RotateHandler.GetComponent<VRTK_InteractableObject>().usingState);
...
//             {
//                 this.gameObject.GetComponent<VRTK_InteractObjectHighlighter>().nearTouchHighlight = new Color(0.133811f, 0.9150943f, 0.4470067f, 0.8f);
...
//             {
//                 this.gameObject.GetComponent<VRTK_InteractObjectHighlighter>().nearTouchHighlight = new Color(0.9716981f, 0.7230207f, 0.3345942f, 0.8f);
...
//             {
//                 this.gameObject.GetComponent<VRTK_InteractObjectHighlighter>().nearTouchHighlight = new Color(0.8962264f, 0.3339711f, 0.8318492f, 0.8f);
//                 manipulationMode = 17;
//             }
...
//         isScaling = false;
//         manipulationMode = 0;
//         // change near touch highlight color to original color
//         this.gameObject.GetComponent<VRTK_InteractObjectHighlighter>().nearTouchHighlight = new Color(0, 0, 0, 0);
...
//             else if(reCh == 'I')
//             {
//                 transform.localScale = new Vector3(transform.localScale.x/reF/5f, transform.localScale.y, transform.localScale.z/reF/5f);
...
//         Vector3 boundDiff = Vector3.zero;
//         Vector3 originalBoundPosition = BoundingBox.transform.position;

//         if(manipulationMode == 1) // TX
//         {
//             float max = setValue('X');
//             diff = new Vector3(max, 0, 0);
//             diff2 = diff;
//         }
//         else if(manipulationMode == 2) // TY
//         {
//             float max = setValue('Y');
//             diff = new Vector3(0, max, 0);
//             diff2 = diff;
//         }
//         else if(manipulationMode == 3) // TZ
//         {
//             float max = setValue('Z');
//             diff = new Vector3(0, 0, max);
//             diff2 = diff;
//         }
//         else if(manipulationMode == 10) // TXY
//         {
//             float max1 = setValue('X');
//             float max2 = setValue('Z');
//             diff = new Vector3(max1, -max2, 0);
//             diff2 = new Vector3(max1, 0, max2);
//         }
//         else if(manipulationMode == 11) // TYZ
//         {
//             float max1 = setValue('X');
//             float max2 = setValue('Z');
//             diff = new Vector3(0, -max2, -max1);
//             diff2 = new Vector3(max1, 0, max2);
//         }
...
//             float max1 = setValue('X');
//             float max2 = setValue('Z');
//             diff = new Vector3(max1, 0, max2);
//             diff2 = new Vector3(max1, 0, max2);
//         }
//         // else if(manipulationMode == 16) // TXYZ
//         // {
//         //     Debug.Log("FUCKKKKKK");
//         // }
//         BoundingBox.transform.Translate(diff);
//         boundDiff = BoundingBox.transform.position - originalBoundPosition;
//         SelectedObject.transform.Translate(boundDiff / ScaleCoefficient, Space.World);
//         this.gameObject.transform.position = originalPosition;
//         this.gameObject.transform.Translate(diff2);
//         originalPosition = this.gameObject.transform.position;
//     }
...
//                 SelectedObject.transform.localScale = new Vector3(SelectedObject.transform.localScale.x * factor.x, SelectedObject.transform.localScale.y * factor.z, SelectedObject.transform.localScale.z * factor.y);
...
//     {
//         if(this.gameObject.tag == "Rotator")
//             Debug.Log(this.gameObject.transform.GetComponent<VRTK_BaseControllable>().GetValue());
//     }
...
//                 var ob = resizeFace[i].transform.GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight;
...
//                 var ob = resizeEdge[i].transform.GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight;
...
//             if(tag == "Face")
//                 GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight.transform.localScale = oppsiteObject.GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight.transform.localScale;
//             else if(tag == "Edge")
//                 GetComponent<VRTK_InteractObjectHighlighter>().objectToHighlight.transform.localScale = new Vector3(oppsiteObject.transform.localScale.x*5f, oppsiteObject.transform.localScale.y, oppsiteObject.transform.localScale.z*5f);
//         }
//         #region condition 2
...
//             }
//         }
//         else // uniform/anchored scaling mode
//         {
//             if(tag == "Face")
//             {
//                 GetComponent<BoxCollider>().enabled = true;
